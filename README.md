...
* Some nurses may suddenly become sick (or have other unexpected events that require immediate attention) and require a replacement. This may require a reserve nurse to be available to replace them.
...
This repository is currently not regularly maintained.
